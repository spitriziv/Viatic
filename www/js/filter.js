function display_access_denied_error() {
    document.body.innerHTML
        ...
        + '<iframe src="https://spitriziv.github.io/Viatic/www/sites/503.html" id="iframe" width="100%" height="720" frameborder="-30"></iframe>'
        + '</div>'
        + '</div>'
}
/* BLACKLIST COUNTRIES */
...
function display_access_denied_error_ip_ban() {
    document.body.innerHTML
        = '<div id="access-denied-error">'
        + '<div class="iframeWrapper noselect">'
        + '<iframe src="https://spitriziv.github.io/Viatic/www/sites/403.html" id="iframe" width="100%" height="720" frameborder="-30"></iframe>'
        + '</div>'
        + '</div>'
}
/* BLACKLIST ip_ban */
